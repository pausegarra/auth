...
<@layout.registrationLayout displayRequiredFields=false displayMessage=!messagesPerField.existsError('totp','userLabel'); section>
    ...
    <#elseif section = "form">
        ...
        <form action="${url.loginAction}" class="${properties.kcFormClass!}" id="kc-totp-settings-form" method="post">
            ...
            <div class="form-group">
                <div class="${properties.kcInputWrapperClass!}">
                    <label for="userLabel" class="${properties.kcLabelClass!}">${msg("loginTotpDeviceName")}</label> <#if totp.otpCredentials?size gt 0><span class="required">*</span></#if>
                </div>
                ...
                <div class="${properties.kcInputWrapperClass!}">
                    ...
                    <#if messagesPerField.existsError('userLabel')>
                        <span id="input-error-user-label" class="${properties.kcInputErrorMessageClass!}" aria-live="polite">
